...
export default function SelfCompassionPage() {
  ...
  const handleNext = () => {
    if (isFormComplete) {
      ...
      localStorage.setItem(`pretest_scs_${sessionId}`, JSON.stringify(responses));
      console.log('SCS-SF-12 data saved to localStorage');
      router.push(`/survey/${sessionId}/pre-test/emotion`);
    }
  };
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-base text-muted-foreground leading-relaxed">
                평소 자신에 대해 어떻게 생각하고 행동하는지 가장 가까운 답변을 선택해주세요
              </p>
            </div>
          </div>
        </div>
